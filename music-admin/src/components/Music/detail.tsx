...
export const DetailMusic = ()=>{
  ...
  return <Container>
          ...
          <FormControl variant="standard" sx={{width: "100%", marginTop:"10px"}}>
              ...
              <BootstrapInput disabled value={detail.category.name}  placeholder='Enter Title' id="bootstrap-input" />
          </FormControl>
          <FormControl variant="standard" sx={{width: "100%", marginTop:"10px"}}>
              <InputLabel shrink htmlFor="bootstrap-input">
              Ca sĩ
              </InputLabel>
              <BootstrapInput disabled value={detail.artist[0].name}  placeholder='Enter Title' id="bootstrap-input" />
          </FormControl>
          <FormControl variant="standard" sx={{width: "100%", marginTop:"10px"}}>
              <InputLabel shrink htmlFor="bootstrap-input">
              Nguồn
              </InputLabel>
              <BootstrapInput disabled value={detail.source}  placeholder='Enter Title' id="bootstrap-input" />
          </FormControl>
          <FormControl variant="standard" sx={{width: "100%", marginTop:"10px"}}>
              <InputLabel shrink htmlFor="bootstrap-input">
              Ảnh
              ...
              src={`${process.env.REACT_APP_CLOUDFRONT_URL}/images/` + detail.image} />
          </FormControl>
